      ...
      {  public void mousePressed(MouseEvent e)
         {  if (isLeftMouseButton(e))
            {  xs = xe = e.getX(); // Left button
               ...
               new JuliaFrame(minIm+factor * yS, minRe+factor * xS);               
            }
            else
...
class JuliaFrame extends Frame{
	JuliaFrame(double cIm, double cRe){
		super("z=" + cRe+"+"+cIm+"i");
	      addWindowListener(new WindowAdapter()
	         {public void windowClosing(WindowEvent e){System.exit(0);}});
	      setSize(200, 200);
	      add("Center", new Julia( cIm,  cRe));
	      show();
	}
}
